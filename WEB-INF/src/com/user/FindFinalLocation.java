    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        for (int i = 0; i < str.length; i++) {
            ...
            if (i == 0) {
                ...
                // double final_val = calculation.distance(Double.parseDouble(main_latitude),
                // Double.parseDouble(main_longitude),latitude1,longitude1, 'K');

                double final_val = EuclideanDis.Distance(Double.parseDouble(main_latitude),
                        Double.parseDouble(main_longitude), latitude1, longitude1);

                // System.out.println(calculation.distance(Double.parseDouble(main_latitude),
                // Double.parseDouble(main_longitude),latitude1,longitude1, 'K') + "
                // Kilometers\n");
        ...
        ArrayList list = UserDAO.getFinalLocation();
