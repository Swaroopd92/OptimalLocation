...
public class Profile_User extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            /*
             * ResultSet rs=UserDAO.getProfile(id); if(rs.next()) {
             * 
             * rs=UserDAO.getProfile(id); request.setAttribute("rs",rs);
             * request.setAttribute("user", id); RequestDispatcher
             * rd=request.getRequestDispatcher("/JSP/User/profile.jsp?no=0");
