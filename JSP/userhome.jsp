...
<form action="">
	<div id="socials-bar">
					...
					<a href="<%=request.getContextPath()%>/JSP/viewprofile.jsp" title="View Profile" target="myframe"><img src="<%=request.getContextPath()%>/Img/User-icon.png" alt="Profile" /><a/>
					
					<a href="<%=request.getContextPath()%>/JSP/select_optimal_location.jsp" title="Initiate Optimal Location" target="myframe"><img src="<%=request.getContextPath()%>/Img/socials/png/48x48/location1.png" alt="facebook page" /><a/>
					
					<a href="<%=request.getContextPath()%>/JSP/view_optimal_location.jsp" title="View Optimal Location" target="myframe" ><img src="<%=request.getContextPath()%>/Img/map-icon.png" alt="Optimal Location Page" /><a/>
					
					<a href="<%=request.getContextPath()%>/PreferredLocation?no=3" title="View Member Preferred Location" target="myframe" ><img src="<%=request.getContextPath()%>/Img/googlemap.png" alt="facebook page" /><a/>
					
					
					<a href="<%=request.getContextPath()%>/JSP/changepass.jsp" title="Change Password" target="myframe" ><img src="<%=request.getContextPath()%>/Img/password-icon.png" alt="change password page" /><a/>
